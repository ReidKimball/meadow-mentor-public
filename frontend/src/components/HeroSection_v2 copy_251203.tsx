    ...
    >
      <Container maxWidth="lg">
        ...
        >
          ...
          >
            Meet Kay, Your Personal Guide for Gut Health.
          </Typography>
          ...
          >
            Meadow Mentor guides you while using therapeutic diets to navigate gut conditions so you can thrive, one meal at a time.
          </Typography>
