...
export default function CheckIngredients_AI(props) {
    ...
    return (
        <section className="suggested-recipe-container max-w-none" aria-live='polite' ref={props.ref}>
            ...
            <div className='py-8 flex items-center gap-2'>
                ...
                <Copy_Text AI_Text={props.ingLabelText} />
            ...
            <article className="prose" aria-live="polite">
                <ReactMarkdown children={props.ingLabelText} remarkPlugins={[remarkGfm]} />
            </article>
        </section>
    )
}